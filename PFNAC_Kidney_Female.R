...
#
# 3/5/2025
# Renamed KidneyRel1f.png as PFNAC_Kidney_Female.png
# Renamed KidneyRel1f as PFNAC_Kidney_Female
...
# Keep rows 61 through the last row for Females
...
ggsave(
  filename = "PFNA_Kidney_Female.png",
  plot = PFNA_Kidney_Female,
  width = 8,
  height = 6,
  dpi = 300
)
